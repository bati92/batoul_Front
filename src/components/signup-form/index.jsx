  ...
  const onSubmit = async ( e) => {
    ...
    try{
      console.log(useField);
        const response=await axios.post("http://localhost:8000/api/register",useField,csrf);
        ...
        <div className={clsx("form-wrapper-one", className)}>
            ...
            <form >
              ...
              <div className="mb-5">
                    ...
                    <select required="" className="myinput25"   onChange={e=>changeUserFieldHandler(e)} name="code">
               ...
               <div className="mb-5">
                ...
                <div className="mb-5">
                    ...
                    <select name="nationality"  onChange={e=>changeUserFieldHandler(e)} id="nationality" required="">
